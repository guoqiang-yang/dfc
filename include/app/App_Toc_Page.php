 ...
 * Time: 13:59
 */
class App_Toc_Page extends App_Toc_Web
{
    ...
    function __construct($lgmode)
    {
        ...
        Tool_CssJs::setCssJsHost(TOC_H5_MAIN_HOST);
        $this->setCssJs();
    }
    ...
    protected function checkAuth()
    {
        ...
        if ($this->lgmode == 'pri' && (!$this->_uid))
        {
            ...
            header('Location: http://' . TOC_H5_MAIN_HOST . '/login/login.php?return_url=' . $referer);
            exit;
        }
    }
    ...
    protected function outputTail()
    {
        ...
        $jsEnv = array("wwwHost" => TOC_H5_MAIN_HOST);
