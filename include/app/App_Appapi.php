...
class App_Appapi extends Base_App
{
    ...
    function __construct($lgmode='pri')
    {
        ...
        $this->cityid = $_REQUEST['city_id']?:Conf_City::BEIJING;
	...
	private function printLog()
	{
		...
		Tool_Log::addFileLog('app_api_call', $info);
	}
    ...
    private function _checkUserInfo()
    {
        ...
        $uid = Crm2_Auth_Api::checkVerify($this->token, Conf_Base::WEB_TOKEN_EXPIRED, $this->source);
