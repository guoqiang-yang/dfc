 ...
 * @link https://github.com/aofong/autosuggest.js
 * 
 */
(function ($) {
                        ...
                        $.each(json, function (i, j) {
                            if (settings.maxNum > i) {
                                if (settings.highlight) {
                                    ...
                                    + j.label + '">' + getStrongText(j.value, matchText) + '<span class="as-assisted-msg">'+j.detail+'</span></span>';
                                } else {
                                    results += '<span href="javascript:void(0)" class="list-group-item ' + alignClass + '" data-id="' + j.id + '" data-value="' + j.value + '"  data-label="'
                                    + j.label + '">' + j.label + '<br><span class="as-assisted-msg">'+j.detail+'</span></span>';
                                }
                                suggestionsNum++;
                            }
                        });
