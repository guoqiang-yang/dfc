...
//            }
    ...
    protected function checkAuth()
    {
        ...
        if (in_array($this->_uid, array(1036, 1029)) && !empty($_REQUEST['test_suid']))
        {
    ...
    protected function setCommonPara()
    {
        ...
        if ($this->_uid)
        {
            ...
            $this->smarty->assign("_isSalesDirectorAssistant", isset($roleLevels[Conf_Admin::ROLE_SALES_DIRECTOR_ASSISTANT]));
            ...
            $this->smarty->assign('_isCommunityCS', isset($roleLevels[Conf_Admin::ROLE_COMMUNITY_CS]));
